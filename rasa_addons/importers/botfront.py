...
class BotfrontFileImporter(TrainingDataImporter):
    def __init__(
        ...
        self.core_config = {}
        self.nlu_config = {}
        self.default_for_multilang_nlu_model = None
        if config_file:
            ...
            for file in config_file:
                ...
                if "default_for_multilang_nlu_model" in config:
                    self.default_for_multilang_nlu_model = lang
        
            if self.default_for_multilang_nlu_model:
                self.nlu_config[self.default_for_multilang_nlu_model]["language"] = [lang for lang in self.nlu_config]
    ...
    async def get_nlu_config(self, languages=True) -> Dict:
        if self.default_for_multilang_nlu_model:
            return {self.default_for_multilang_nlu_model: self.nlu_config[self.default_for_multilang_nlu_model]}
