...
def action_for_name_or_text(
    ...
    # bf >
    elif domain.forms.get(action_name_or_text) is not None and "required_slots" in domain.forms.get(action_name_or_text) and domain.forms.get(action_name_or_text)["required_slots"].get("graph_elements") is not None:
